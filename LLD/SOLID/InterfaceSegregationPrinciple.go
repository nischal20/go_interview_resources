...
// Instead of one large, general-purpose interface, multiple smaller, more specific interfaces should be created. This allows clients to depend only on the methods that are relevant to them.
package main
